...
```
$ DOCKER_HOST=trashcan DOCKER_BUILDKIT=1 docker build -t twined/fehn:3.8 .
$ DOCKER_HOST=trashcan DOCKER_BUILDKIT=1 docker push twined/fehn:3.8
```
...
FROM --platform=linux/amd64 twined/fehn:3.8
