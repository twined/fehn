...
```
$ DOCKER_HOST=trashcan DOCKER_BUILDKIT=1 docker build -t twined/fehn:3.9 .
$ DOCKER_HOST=trashcan DOCKER_BUILDKIT=1 docker push twined/fehn:3.9
```
...
FROM --platform=linux/amd64 twined/fehn:3.9
